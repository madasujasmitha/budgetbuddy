...
export default function MoneyJournal() {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <p className="text-muted-foreground mb-6">Write a quick reflection each day. Entries are saved as stickers.</p>

      <Card className="border-2 border-primary/20">
        <CardHeader className="pb-3">
          <CardTitle className="text-xl">Add Today&apos;s Entry</CardTitle>
        </CardHeader>
